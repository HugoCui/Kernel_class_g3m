...
class StateEvolution(object):
    ...
    def _initialise(self):
        ...
        self.hatoverlaps['variance'][0],self.hatoverlaps['self_overlap'][0],self.hatoverlaps['teacher_student'][0]=self.model._update_hatoverlaps(
                self.overlaps['variance'][0],self.overlaps['self_overlap'][0],
                                               self.overlaps['teacher_student'][0])
    ...
    def iterate(self):
        ...
        for t in range(self.max_steps):
            ...
            self.hatoverlaps['variance'][t+1],self.hatoverlaps['self_overlap'][t+1],self.hatoverlaps['teacher_student'][t+1]=self.model._update_hatoverlaps(
                self.overlaps['variance'][t],self.overlaps['self_overlap'][t],
                                               self.overlaps['teacher_student'][t])
            
            Vtmp, qtmp, mtmp = self.model._update_overlaps(self.hatoverlaps['variance'][t+1],self.hatoverlaps['self_overlap'][t+1],self.hatoverlaps['teacher_student'][t+1])
